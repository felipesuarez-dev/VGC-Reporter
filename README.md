...
Pre-built installers for the **`v0.1.10.20260425-beta`** release:

| Platform | Installer | Notes |
|---|---|---|
| Windows 10/11 | `VGC.Reporter_0.1.10_x64_en-US.msi` | MSI installer (recommended) |
| Windows 10/11 | `VGC.Reporter_0.1.10_x64-setup.exe` | NSIS installer (portable-friendly) |
| macOS 12+ (Apple Silicon) | `VGC.Reporter_0.1.10_aarch64.dmg` | Unsigned — right-click → Open the first time |
| macOS 12+ (Intel) | `VGC.Reporter_0.1.10_x64.dmg` | Unsigned — right-click → Open the first time |
| Linux (Debian/Ubuntu) | `vgc-reporter_0.1.10_amd64.deb` | Requires `webkit2gtk-4.1` |
| Linux (any distro) | `vgc-reporter_0.1.10_amd64.AppImage` | `chmod +x` then run |
| Android 7+ (arm64) | `VGC.Reporter_v0.1.10.20260425-beta_android.apk` | Sideload: enable "Unknown sources" first |
...
[version-badge]: https://img.shields.io/badge/version-0.1.10.20260425--beta-2b86ff?style=flat-square&labelColor=0a0e14
